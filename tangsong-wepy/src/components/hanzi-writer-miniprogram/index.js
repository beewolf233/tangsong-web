...
var HanziWriterContext = function () {
  function HanziWriterContext(_ref) {
    var id = _ref.id,
        ...
        drawingWidth = _ref.drawingWidth,
    ...
    this.writer = new _hanziWriter2.default(this.comp, (0, _utils.removeEmptyKeys)({
      ...
      rendererOverride: { createRenderTarget: _RenderTarget2.default.init(renderCanvas) },
      renderer: 'canvas'
    }));
...
var RenderTarget = function () {
  function RenderTarget(view, canvas) {
  ...
  RenderTarget.prototype._getClientBoundingRect = function _getClientBoundingRect() {
    ...
    return new Promise(function (resolve) {
      _this2.view.createSelectorQuery().select('#' + _this2.view.data.canvasId).boundingClientRect(resolve).exec();
    });
  };
...
RenderTarget.init = function (canvas) {
  return function (initData) {
    return new RenderTarget(initData, canvas);
  };
};
